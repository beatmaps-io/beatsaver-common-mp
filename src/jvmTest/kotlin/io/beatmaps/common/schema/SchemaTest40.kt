    ...
    fun error() {
        ...
        assertContentEquals(
            listOf(
                ...
                violation4<NodePresent>("colorNotes[2].b(beat)"),
                violation4<NodePresent>("colorNotes[2].r(rotationLane)"),
                violation4<NodePresent>("colorNotes[2].i(index)"),
                ...
                violation4<NodePresent>("colorNotesData[2].x"),
                violation4<NodePresent>("colorNotesData[2].y"),
                violation4<NodePresent>("colorNotesData[2].c(color)"),
                violation4<NodePresent>("colorNotesData[2].d(direction)"),
                violation4<NodePresent>("colorNotesData[2].a(angleOffset)"),
                ...
                violation4<NodePresent>("bombNotes[2].b(beat)"),
                violation4<NodePresent>("bombNotes[2].r(rotationLane)"),
                violation4<NodePresent>("bombNotes[2].i(index)"),
                ...
                violation4<NodePresent>("bombNotesData[2].x"),
                violation4<NodePresent>("bombNotesData[2].y"),
                ...
                violation4<NodePresent>("obstacles[2].b(beat)"),
                violation4<NodePresent>("obstacles[2].r(rotationLane)"),
                violation4<NodePresent>("obstacles[2].i(index)"),
                ...
                violation4<NodePresent>("obstaclesData[2].d(duration)"),
                violation4<NodePresent>("obstaclesData[2].x"),
                violation4<NodePresent>("obstaclesData[2].y"),
                violation4<NodePresent>("obstaclesData[2].w(width)"),
                violation4<NodePresent>("obstaclesData[2].h(height)"),
                ...
                violation4<NodePresent>("arcs[2].hb(beat)"),
                violation4<NodePresent>("arcs[2].tb(tailBeat)"),
                violation4<NodePresent>("arcs[2].hr(headRotationLane)"),
                violation4<NodePresent>("arcs[2].tr(tailRotationLane)"),
                violation4<NodePresent>("arcs[2].ai(index)"),
                violation4<NodePresent>("arcs[2].hi(headIndex)"),
                violation4<NodePresent>("arcs[2].ti(tailIndex)"),
                ...
                violation4<NodePresent>("arcsData[2].m(headControlPointLengthMultiplier)"),
                violation4<NodePresent>("arcsData[2].tm(tailControlPointLengthMultiplier)"),
                violation4<NodePresent>("arcsData[2].a(midAnchorMode)"),
                ...
                violation4<NodePresent>("chains[2].hb(beat)"),
                violation4<NodePresent>("chains[2].tb(tailBeat)"),
                violation4<NodePresent>("chains[2].hr(headRotationLane)"),
                violation4<NodePresent>("chains[2].tr(tailRotationLane)"),
                violation4<NodePresent>("chains[2].ci(index)"),
                violation4<NodePresent>("chains[2].i(headIndex)"),
                ...
                violation4<NodePresent>("chainsData[2].tx(x)"),
                violation4<NodePresent>("chainsData[2].ty(y)"),
                violation4<NodePresent>("chainsData[2].c(sliceCount)"),
                violation4<NodePresent>("chainsData[2].s(squishAmount)"),
                ...
                violation4<NodePresent>("spawnRotations[2].b(beat)"),
                violation4<NodePresent>("spawnRotations[2].i(index)"),
