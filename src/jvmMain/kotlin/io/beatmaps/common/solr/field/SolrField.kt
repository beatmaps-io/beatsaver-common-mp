...
data class SolrField<T>(private val collection: SolrCollection, val name: String) : SolrFunction<T>() {
    ...
    override infix fun lessEq(value: T) = lessThanEq(this, "$value")
    override infix fun greaterEq(value: T) = greaterThanEq(this, "$value")
    override infix fun less(value: T) = lessThan(this, "$value")
    override infix fun greater(value: T) = greaterThan(this, "$value")
